...
public class DrawingComponentRepainter extends DrawingListenerAdapter
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (handleActiveViewChange(evt, name)) {
      component.repaint();
      return;
    } 

    if (handleDrawingChange(evt, name)) {
      component.repaint();
      return;
    }
  ...
  private boolean handleActiveViewChange(PropertyChangeEvent evt, String name) {
  ...
  private boolean handleDrawingChange(PropertyChangeEvent evt, String name) {
