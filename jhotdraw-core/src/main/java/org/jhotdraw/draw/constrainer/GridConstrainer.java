...
public class GridConstrainer extends AbstractConstrainer {
  ...
  public void draw(Graphics2D g, DrawingView view) {
        if (isVisible) {
          ...
          drawVerticalGridLines(g, view, t, viewBounds, origin, point, viewPoint);
          drawHorizontalGridLines(g, view, t, viewBounds, origin, point, viewPoint);
        }
      }
      ...
      private void drawVerticalGridLines(
        ...
        if (width * view.getScaleFactor() > 2) {
          drawMinorVerticalGridLines(g, t, viewBounds, origin, point, viewPoint);
        } else if (width * majorGridSpacing * view.getScaleFactor() > 2) {
          drawMajorVerticalGridLines(g, t, viewBounds, origin, point, viewPoint);
        }
      }
      ...
      private void drawHorizontalGridLines(
        ...
        if (height * view.getScaleFactor() > 2) {
          drawMinorHorizontalGridLines(g, t, viewBounds, origin, point, viewPoint);
        } else if (height * majorGridSpacing * view.getScaleFactor() > 2) {
          drawMajorHorizontalGridLines(g, t, viewBounds, origin, point, viewPoint);
        }
      }
    
      private void drawMinorVerticalGridLines(
          Graphics2D g,
          AffineTransform t,
          Rectangle viewBounds,
          Point2D.Double origin,
        ...
        for (int i = (int) (origin.x / width), m = (int) ((origin.x + viewBounds.width) / width) + 1;
            i <= m;
            i++) {
      ...
      private void drawMajorVerticalGridLines(
          Graphics2D g,
          AffineTransform t,
          Rectangle viewBounds,
          Point2D.Double origin,
      ...
      private void drawMinorHorizontalGridLines(
          Graphics2D g,
          AffineTransform t,
          Rectangle viewBounds,
          Point2D.Double origin,
          ...
          Point2D.Double viewPoint) {
        g.setColor(minorColor);
        for (int i = (int) (origin.y / height),
                m = (int) ((origin.y + viewBounds.height) / height) + 1;
            i <= m;
            i++) {
          g.setColor((i % majorGridSpacing == 0) ? majorColor : minorColor);
          point.y = height * i;
      ...
      private void drawMajorHorizontalGridLines(
          Graphics2D g,
          AffineTransform t,
          Rectangle viewBounds,
          Point2D.Double origin,
