...
public class ResourceBundleUtil implements Serializable {
  ...
  private String getStringRecursive(String key) throws MissingResourceException {
    ...
    private String substitutePlaceholders(String value) throws MissingResourceException {
        for (int p1 = value.indexOf("${"); p1 != -1; p1 = value.indexOf("${")) {
            ...
            String placeholderValue = getPlaceholderValue(placeholderKey);
    ...
    private String getPlaceholderValue(String placeholderKey) throws MissingResourceException {
        ...
        if (placeholderValue == null) {
            throw new MissingResourceException(
                    "\"" + placeholderKey + "\" not found in " + baseName, baseName, placeholderKey);
        }
        // Do post-processing depending on placeholder format
        if ("accelerator".equals(placeholderFormat)) {
            placeholderValue = localizeAcceleratorKeywords(placeholderValue);
        }
        return placeholderValue;
    }

    private String localizeAcceleratorKeywords(String placeholderValue) {
