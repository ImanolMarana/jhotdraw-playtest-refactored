...
public class JavaNumberFormatter extends DefaultFormatter {
  ...
  public String valueToString(Object value) throws ParseException {
    ...
    if (value instanceof Double) {
      ...
      if (!usesScientificNotation
          || exponent > minNegativeExponent && exponent < minPositiveExponent) {
  ...
  public Object stringToValue(String text) throws ParseException {
        ...
        Object value;
        if (valueClass != null) {
          value = parseValue(valueClass, text);
        } else {
      ...
      private Object parseValue(Class<?> valueClass, String text) throws ParseException {
        try {
...
//Refactoring end
   ...
   */
  public static AbstractFormatterFactory createFormatterFactory(
      double min, double max, double multiplier, boolean allowsNullValue) {
    JavaNumberFormatter formatter =
        new JavaNumberFormatter(min, max, multiplier, allowsNullValue, null);
  ...
  public static AbstractFormatterFactory createFormatterFactory(
      double min, double max, double multiplier, boolean allowsNullValue, String unit) {
    JavaNumberFormatter formatter =
        new JavaNumberFormatter(min, max, multiplier, allowsNullValue, unit);
    return new DefaultFormatterFactory(formatter);
  }
}
