...
public class CSSParser {
  ...
  private Map<String, String> parseDeclarationMap(StreamTokenizer tt) throws IOException {
    ...
    do {
      StringBuilder key = parseDeclarationKey(tt);
      ...
      StringBuilder value = parseDeclarationValue(tt);
  ...
  private StringBuilder parseDeclarationKey(StreamTokenizer tt) throws IOException {
  ...
  private StringBuilder parseDeclarationValue(StreamTokenizer tt) throws IOException {
