...
/**
 * This is an extension of the Swing {@code JPopupMenu} which can be used to display a {@code
 * JComponent} in a popup menu.
 *
...
public class JComponentPopup extends JPopupMenu {
    ...
    public void eventDispatched(AWTEvent ev) {
      ...
      if (ev.getID() == MouseEvent.MOUSE_PRESSED) {
        ...
        if (!SwingUtilities.isDescendingFrom(src, JComponentPopup.this)
            && SwingUtilities.getWindowAncestor(src) == SwingUtilities.getWindowAncestor(invoker)) {
          JLayeredPane srcLP =
              (JLayeredPane) SwingUtilities.getAncestorOfClass(JLayeredPane.class, src);
  ...
  public void menuSelectionChanged(boolean isIncluded) {
        ...
        handleMenuSelectionWithoutAWTListener();
      }
    
      private void handleMenuSelectionWithoutAWTListener() {
