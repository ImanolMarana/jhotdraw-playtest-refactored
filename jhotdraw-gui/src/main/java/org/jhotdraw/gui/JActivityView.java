...
public class JActivityView extends javax.swing.JPanel {
  ...
  private void updateProperties(PropertyChangeEvent evt) {
        ...
        if (name.equals(ActivityModel.NOTE_PROPERTY)) {
            updateNote();
        } else if (name.equals(ActivityModel.WARNING_PROPERTY)) {
            updateWarning();
        } else if (name.equals(ActivityModel.ERROR_PROPERTY)) {
            updateError();
        } else if (name.equals(ActivityModel.CANCELABLE_PROPERTY)) {
            updateCancelable();
        } else if (name.equals(ActivityModel.CANCELED_PROPERTY)) {
            updateCanceled();
            updateCancelable();
        } else if (name.equals(ActivityModel.INDETERMINATE_PROPERTY)) {
            updateIndeterminate();
        } else if (name.equals(ActivityModel.CLOSED_PROPERTY)) {
            updateCancelable();
            updateCanceled();
            updateClosed();
        }
