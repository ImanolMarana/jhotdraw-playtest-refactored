...
public class JSheet extends JDialog {
  ...
  protected boolean isShowAsSheet() {
    return UIManager.getLookAndFeel().getID().equals("Aqua")
        || UIManager.getBoolean("Sheet.showAsSheet");
  }
  ...
  protected void fireOptionSelected(JOptionPane pane) {
        ...
        int option = getOptionPaneOption(pane, value);
        fireOptionSelected(pane, option, value, pane.getInputValue());
    }
    
    private int getOptionPaneOption(JOptionPane pane, Object value) {
        if (value == null) {
            ...
            for (int i = 0, n = pane.getOptions().length; i < n; i++) {
                if (pane.getOptions()[i].equals(value)) {
                    option = i;
                    break;
                }
            }
...
//Refactoring end
   ...
   *
   * @param parentComponent determines the <code>Frame</code> in which the sheet is displayed; if
  ...
  public static void showConfirmSheet(
      Component parentComponent, Object message, SheetListener listener) {
   ...
   */
  public static void showConfirmSheet(
      Component parentComponent, Object message, int optionType, SheetListener listener) {
   ...
   */
  public static void showInputSheet(
      Component parentComponent, Object message, int messageType, SheetListener listener) {
   ...
   * @param parentComponent the parent <code>Component</code> for the dialog
   * @param message the <code>Object</code> to display
   * @param messageType the type of message to be displayed: <code>JOptionPane.ERROR_MESSAGE</code>,
   *     <code>JOptionPane.INFORMATION_MESSAGE</code>, <code>JOptionPane.WARNING_MESSAGE</code>,
   *     <code>JOptionPane.QUESTION_MESSAGE</code>, * or <code>JOptionPane.PLAIN_MESSAGE</code>
  ...
  public static void showMessageSheet(Component parentComponent, Object message) {
    showMessageSheet(parentComponent, message, JOptionPane.INFORMATION_MESSAGE);
  }
   ...
   */
  public static void showMessageSheet(
      Component parentComponent, Object message, SheetListener listener) {
    showMessageSheet(parentComponent, message, JOptionPane.INFORMATION_MESSAGE, listener);
  }
   ...
   *     <code>JOptionPane.INFORMATION_MESSAGE</code>, <code>JOptionPane.WARNING_MESSAGE</code>,
   *     <code>JOptionPane.QUESTION_MESSAGE</code>, * or <code>JOptionPane.PLAIN_MESSAGE</code>
   * @param icon an icon to display in the sheet that helps the user identify the kind of message
   ...
   *
   * @param parentComponent the <code>Component</code> to check for a <code>Frame</code> or <code>
   *     Dialog</code>
