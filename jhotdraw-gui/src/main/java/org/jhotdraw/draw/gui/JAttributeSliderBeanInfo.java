...
public class JAttributeSliderBeanInfo extends SimpleBeanInfo {
  ...
  public java.awt.Image getIcon(int iconKind) {
        return switch (iconKind) {
            case ICON_COLOR_16x16 -> getIcon(iconNameC16, iconColor16);
            case ICON_COLOR_32x32 -> getIcon(iconNameC32, iconColor32);
            case ICON_MONO_16x16 -> getIcon(iconNameM16, iconMono16);
            case ICON_MONO_32x32 -> getIcon(iconNameM32, iconMono32);
            default -> null;
        };
    }
