...
public class FontToolBar extends AbstractToolBar {
  ...
  public void setEditor(DrawingEditor newValue) {
    ...
    if (newValue != null) {
      createSelectionComponentDisplayer();
    }
  }

  private void createSelectionComponentDisplayer() {
  ...
  protected JComponent createDisclosedComponent(int state) {
    ...
    switch (state) {
      case 1:
        ...
        faceField.setUI(
            (PaletteFormattedTextFieldUI) PaletteFormattedTextFieldUI.createUI(faceField));
        ...
        sizeField.setUI(
            (PaletteFormattedTextFieldUI) PaletteFormattedTextFieldUI.createUI(sizeField));
