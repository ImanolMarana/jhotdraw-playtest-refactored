...
public class SVGDrawingPanel extends JPanel implements Disposable {
  ...
  public void read(URI f) throws IOException {
        ...
        for (InputFormat format : newDrawing.getInputFormats()) {
            try {
                readDrawingWithFormat(f, newDrawing, format);
    ...
    private void readDrawingWithFormat(URI f, Drawing newDrawing, InputFormat format) throws IOException {
...
//Refactoring end
  ...
  private void initComponents() {
    ...
    toolsScrollPane.setVerticalScrollBarPolicy(
