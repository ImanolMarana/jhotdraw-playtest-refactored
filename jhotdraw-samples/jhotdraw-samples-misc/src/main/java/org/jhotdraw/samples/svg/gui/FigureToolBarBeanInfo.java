...
public class FigureToolBarBeanInfo extends SimpleBeanInfo {
  ...
  private static BeanDescriptor getBdescriptor() {
    ...
    if (beanDescriptor == null) {
      beanDescriptor = new BeanDescriptor(FigureToolBarBeanInfo.class);
    }
    beanDescriptor.setValue("isContainer", Boolean.FALSE);
    beanDescriptor.setDisplayName("LinkToolPane");
  ...
  public java.awt.Image getIcon(int iconKind) {
        switch (iconKind) {
            case ICON_COLOR_16x16:
                return getIcon(iconNameC16, iconColor16);
            case ICON_COLOR_32x32:
                return getIcon(iconNameC32, iconColor32);
            case ICON_MONO_16x16:
                return getIcon(iconNameM16, iconMono16);
            case ICON_MONO_32x32:
                return getIcon(iconNameM32, iconMono32);
            default:
                return null;
        }
    }

    private java.awt.Image getIcon(String iconName, java.awt.Image icon) {
        if (iconName == null) {
            return null;
        } else {
            if (icon == null) {
