...
public class ODGPropertiesPanelBeanInfo extends SimpleBeanInfo {
  ...
  private static BeanDescriptor getBdescriptor() {
    ...
    if (beanDescriptor == null) {
      beanDescriptor = new BeanDescriptor(ODGPropertiesPanelBeanInfo.class);
    }
    beanDescriptor.setValue("isContainer", Boolean.FALSE);
    beanDescriptor.setDisplayName("ODGPropertiesPanel");
  ...
  public java.awt.Image getIcon(int iconKind) {
    ...
    private java.awt.Image getIcon(String iconName, java.awt.Image iconCache) {
        if (iconName == null) {
            return null;
        } else {
            if (iconCache == null) {
                iconCache = loadImage(iconName);
            }
            return iconCache;
        }
    }
